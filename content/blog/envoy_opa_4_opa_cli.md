...
The source code for this getting started examples is located on Github. <span style="color:blue"> ------>  [Envoy & OPA GS # 4](https://github.com/helpfulBadger/envoy_getting_started/tree/master/04_opa_cli) </span>
